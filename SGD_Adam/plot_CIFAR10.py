...
if __name__ == '__main__':
    ...
    ## load SGD data
    sgd_evaluation_history_TEST = torch.load('./my_exp/SGD_evaluation_history_TEST.hist', map_location='cpu')
    sgd_evaluation_history_TRAIN = torch.load('./my_exp/SGD_evaluation_history_TRAIN.hist', map_location='cpu')
    ...
    ## load ADAM data
    adam_evaluation_history_TEST = torch.load('./my_exp/ADAM_evaluation_history_TEST.hist', map_location='cpu')
    adam_evaluation_history_TRAIN = torch.load('./my_exp/ADAM_evaluation_history_TRAIN.hist', map_location='cpu')
    ...
    plt.tight_layout()
    plt.show()
    plt.savefig("./my_exp/comparison.png")

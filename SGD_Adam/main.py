...
from utils import get_grads, alpha_estimator
import numpy as np
...
if __name__ == '__main__':
    ...
    for i, (x, y) in enumerate(circ_train_loader):
        ...
        if (i > 30000 and i % 5000 == 0) or i <=1:
            # pdb.set_trace()
            path_save = ('%s/new_%s_%s_%s_%d_%d_%.5f_%.2f_%d_%d/'%(args.save_dir,args.dataset,args.optimizer,args.model,args.depth,args.width,args.lr,args.mom,args.batch_size_train,args.iterations))
